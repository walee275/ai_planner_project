    ...
    <div class="row py-5">
        <div class="col text-center" style="padding: 20px;">
            ...
            <form action="{{ route('login') }}" class="text-center m-auto" method="POST">
                @csrf
                <input type="text" class="form-control mb-2 ml-5 w-75" style="margin: auto;" name="email" id="email"
                    value="{{ old('email') }}" placeholder="Enter your email">
                <input type="password" class="form-control mb-2 w-75 ml-5" style="margin: auto;" name="password"
