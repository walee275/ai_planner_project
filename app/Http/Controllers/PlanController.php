    ...
    {
        {
            ...
            $message =
                'this prompt is being asked to you using an openai API. So if the prompt is not asking you queries  about creation of a plan for something, or if its not about asking you for like creating any strategy,plan,or you giving the path way of something. then respond "You can only ask for any plan creation".Your response structure should be like this ( <p> sure here is the plan for {here will be the plan title the user asked for}</p>, the there will be an ul list of the plan\'s tasks where every list will have the task tile in bold and its description. like this (<li><b> :</b> description</li>  prompt: '.$request->prompt .'.' ;
